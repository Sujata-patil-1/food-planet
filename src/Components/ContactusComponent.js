        ...
        <div className="container">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        Patiala, Punjab<br />
                        India<br />
                        <i className="fa fa-phone"></i>: +91 80000-74859<br />
                        <i className="fa fa-fax"></i>: +91 45555-32775<br />
                        <i className="fa fa-envelope"></i>: <a href="mailto:foodBonanza@food.net">foodBonanza@food.net</a>
                        </address>
                </div>
                <div className="col-12 col-sm-6 offset-sm-1">
                    <h5>Map of our Location</h5>
                    <iframe className="map" src="" style={{ width:600, height:450, frameborder:0, border:0 }} allowfullscreen="" aria-hidden="false" tabindex="0" ></iframe>
                </div>
